...
description: "AI agent supply chain attacks don't need to run code. A prompt injection hidden in a tool description, arriving through a dependency update, is enough. Here's how to stop them."
---

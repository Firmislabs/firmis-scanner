...
description: "Tool poisoning. Data exfiltration. Hardcoded credentials. MCP servers surface all three. This guide walks from first scan to CI enforcement in under ten minutes."
---
